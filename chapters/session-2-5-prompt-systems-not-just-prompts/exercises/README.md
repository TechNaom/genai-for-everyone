...
4. Run it: `python starter.py` (no API key needed — this exercise tests the templates' structure and your test-writing, not live model output)
...
See `solution.py` in this folder for a complete worked library with 5 templates and test checks.
