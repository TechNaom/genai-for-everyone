"""
Exercise — Session 3.1: Why LLMs Need External Knowledge

The "RAG or Not?" Decision Worksheet.
...
Then run this file: python3 starter.py
...
def print_worksheet(scenarios):
    ...
    if incomplete:
        ...
        print("All six scenarios filled in. Compare your reasoning against")
        print("solution.py once you've made a genuine attempt.")
