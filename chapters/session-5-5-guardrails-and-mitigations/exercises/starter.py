...
This file is already a complete, working implementation (each TODO section
below is filled in) — trace through how classify_input_risk(),
apply_output_guardrail(), and chat() compose the three layers, run it, then
use the "Ideas to extend" list in the exercise page to push it further.
"""
