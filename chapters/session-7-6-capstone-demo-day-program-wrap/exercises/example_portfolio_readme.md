<!-- Reference / example only — this is a worked example of a portfolio README
     that passes the checker, for a fictional capstone. Compare your own
     PORTFOLIO_README.md against this shape; don't copy it verbatim. -->
