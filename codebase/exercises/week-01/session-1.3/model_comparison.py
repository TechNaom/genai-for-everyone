...
Run this file once you've filled in RESULTS: python model_comparison.py
"""
...
TASK_USED = None  # TODO: write the exact task text you tested everywhere


# Fill in one dictionary per model you tested.
...
RESULTS = [
    {
        "model_name": None,        # TODO e.g. "Claude Haiku" or "GPT-4o-mini"
        "provider": None,          # TODO e.g. "Anthropic"
        ...
        "notes": None,             # TODO anything you observed worth flagging
    },
    {
        "model_name": None,
        "provider": None,
