...
class GuardedChatbot:
    ...
    def classify_input_risk(self, user_input: str) -> str:
        """
        TODO 1: Implement input risk classification.
        Return "blocked" if the input matches injection/jailbreak patterns.
    ...
    def apply_output_guardrail(self, response: str) -> str:
        """
        TODO 2: Implement output filtering.
        Block/redact responses containing:
    ...
    def chat(self, user_id: str, user_input: str) -> str:
        """
        TODO 3: Wire up all three layers.
...
def run_red_team_regression():
    ...
    if blocked_count == len(attacks):
        ...
        print("⚠️  Some attacks still succeed. Review your guardrail logic.")
